...
postgresql_configure_replication_parameters() {
    ...
    postgresql_set_property "log_destination" "$POSTGRESQL_LOG_DESTINATION"
    postgresql_set_property "logging_collector" "$POSTGRESQL_LOGGING_COLLECTOR"
    postgresql_set_property "log_directory" "$POSTGRESQL_LOG_DIRECTORY"
    postgresql_set_property "log_filename" "$POSTGRESQL_LOG_FILENAME"
    postgresql_set_property "log_replication_commands" "$POSTGRESQL_LOG_REPLICATION_COMMANDS"
