...
postgresql_env_vars=(
    ...
    POSTGRESQL_LOG_REPLICATION_COMMANDS
...
export POSTGRESQL_LOG_DIRECTORY="${POSTGRESQL_LOG_DIRECTORY:-log}"
export POSTGRESQL_LOG_FILENAME="${POSTGRESQL_LOG_FILENAME:-postgresql-%Y-%m-%d_%H%M%S.log}"
export POSTGRESQL_LOGGING_COLLECTOR="${POSTGRESQL_LOGGING_COLLECTOR:-on}"
export POSTGRESQL_LOG_DESTINATION="${POSTGRESQL_LOG_DESTINATION:-csvlog}"
export POSTGRESQL_LOG_REPLICATION_COMMANDS="${POSTGRESQL_LOG_REPLICATION_COMMANDS:-on}"
